...
const socialLinks = [
    {
        name: 'Twitter', href: 'https://twitter.com/emmanuelrichard01', icon: (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                    ...
                    <div className="flex flex-col items-center md:items-start gap-3">
                        <Link href="/" className="flex items-center gap-2">
                            ...
                            <span className="text-lg font-bold text-foreground">Ultra News</span>
                        </Link>
                        ...
                        <div className="flex gap-3">
                            {socialLinks.map((social) => (
                                <a
                                    key={social.name}
                                    href={social.href}
                                    className="p-2 rounded-lg text-foreground-muted hover:text-foreground hover:bg-[var(--background-elevated)] transition-all duration-200"
