...
export default function FeedItem({ title, slug, source, url, imageUrl, publishedDate, category, highlightQuery }: FeedItemProps) {
    ...
    return (
        <article className="group py-6 border-b border-[var(--border)] last:border-0 hover:bg-[var(--background-elevated)] transition-colors duration-200 -mx-4 px-4 sm:rounded-lg">
